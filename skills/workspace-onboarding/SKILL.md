...
3. Use `ask_user` to confirm CI for every included project, dependency relationships, and model pins. Discovered scripts are evidence, not consent. Do not infer CI requirements or model preferences without confirmation. Ask normal conversational questions for open-ended requirements.
